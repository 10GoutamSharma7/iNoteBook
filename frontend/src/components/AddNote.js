    ...
    return (
      <div className="addnote-suspended-wrapper">
        ...
        <form className="addnote-suspended-form">
          ...
          {/* Adding Reminder */}
          <div className="addnote-block addnote-block-reminder">
            <label htmlFor="reminder" className="form-label" style={{fontFamily: 'Indie Flower, Caveat, Shadows Into Light', fontSize: '2rem'}}>Reminder</label>
            <input
              type="datetime-local"
              className="form-control"
              id="reminder"
